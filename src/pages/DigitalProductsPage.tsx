...
export const DigitalProductsPage: React.FC<DigitalProductsPageProps> = ({ navigate, categoryFilter }) => {
  ...
  const pageCanonical = categoryFilter
    ? `/digital-products/${categoryFilter}`
    : '/digital-products';

  const pageTitle = categoryFilter
    ? `${selectedCategory} — Premium Digital Assets & Templates | BRANIFY`
    : 'Digital Products, Templates & AI Prompt Kits | BRANIFY';

  const pageDesc = categoryFilter
    ? `Download commercial ${selectedCategory} designed for rapid execution, creators, and modern businesses.`
    : 'Instant download AI prompt kits, Canva templates, Notion workspaces, and startup financial models designed for rapid execution.';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      <SEOHead
        ...
        breadcrumbs={[
          ...
          ...(categoryFilter ? [{ name: selectedCategory, url: pageCanonical }] : [])
        ]}
      />
