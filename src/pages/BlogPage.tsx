    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      {selectedPost ? (
        <div className="space-y-8 max-w-4xl mx-auto">
          <SEOHead
            title={`${selectedPost.title} | BRANIFY Blog`}
        ...
        <>
          <SEOHead
            ...
            description="Actionable insights on website design, engineering, branding, AI solutions, and digital growth from the BRANIFY team."
            canonicalPath="/blog"
            breadcrumbs={[
              { name: 'Home', url: '/' },
              { name: 'Blog', url: '/blog' }
