...
export const AboutPage: React.FC<AboutPageProps> = ({ navigate }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      <SEOHead
        title="About BRANIFY | Digital Agency & Technology Partner"
        description="Learn about BRANIFY, our mission, values, and how we help businesses build resilient digital experiences, custom websites, and AI systems."
        canonicalPath="/about"
        breadcrumbs={[
          { name: 'Home', url: '/' },
