...
export const PricingPage: React.FC<PricingPageProps> = ({ navigate }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      <SEOHead
        title="Transparent Pricing Plans & Custom Quotes | BRANIFY"
        description="Clear, upfront pricing for web development, brand identity design, and AI automation. No surprise fees or hidden costs."
