...
export const CartPage: React.FC<CartPageProps> = ({ navigate }) => {
  ...
  if (checkoutStep === 'success') {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center space-y-6">
        <SEOHead
          title="Order Confirmed | BRANIFY Store"
          description="Your order has been confirmed. Instant digital access links have been dispatched."
          canonicalPath="/cart"
        />
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      <SEOHead
        title="Shopping Cart & Checkout | BRANIFY Store"
        description="Review your digital templates, prompt kits, or service package selections and complete instant checkout."
        canonicalPath="/cart"
        breadcrumbs={[
          { name: 'Home', url: '/' },
          { name: 'Cart', url: '/cart' }
