...
export const AIToolsPage: React.FC<AIToolsPageProps> = ({ navigate }) => {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0D] text-white py-12 px-4 sm:px-6 lg:px-8 space-y-12">
      <SEOHead
        title="AI Tools Directory — 27+ Popular AI Tools | BRANIFY"
        description="Explore 27+ popular AI tools organized by category. Find the best AI assistants, image generators, coding copilots, and automation tools."
