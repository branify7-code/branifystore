...
export const FreeTemplatesPage: React.FC<FreeTemplatesPageProps> = ({
  ...
  const pageCanonical = categoryFilter ? `/free-templates/${categoryFilter}` : '/free-templates';
  const pageTitle = categoryFilter
    ? `${categoryFilter.charAt(0).toUpperCase() + categoryFilter.slice(1)} Free Templates | BRANIFY`
    : 'Free Website & Design Templates | BRANIFY';
  const pageDesc = 'Download free website templates, Canva graphics, Notion dashboards, and developer boilerplates created by BRANIFY.';
